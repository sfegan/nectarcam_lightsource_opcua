...
class CalibrationBoxServer:
    ...
    _MONITORING_VARS: ClassVar[list[tuple]] = [
        ("device_host",                  "",      UA_STRING,     STATUS_GOOD,
         "IP address or hostname of the calibration light source device"),
        ("device_port",                  0,       UA_UINT16,     STATUS_GOOD,
